...
extern int WStrlen(const wchar_t *);
...
extern size_t CANNA_mbstowcs(wchar_t *, const char *, size_t);
extern int CANNA_wcstombs(char *, const wchar_t *, int);
...
extern int CNvW2E(const wchar_t *, int, char *, int);
