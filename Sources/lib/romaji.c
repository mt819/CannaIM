...
const struct NormalizePair norm_pair[] = {
    ...
    { "\xa4\xb5\xb7\xab゛", "\xa4\xb8" }, /*{"し゛", "じ"}*/
    { "\xa4\xb5\xb9\xab゛", "\xa4\xba" }, /*{"す゛", "ず"}*/
    { "\xa4\xb5\xbb\xab゛", "\xa4\xbc" }, /*{"せ゛", "ぜ"}*/
    { "\xa4\xb5\xbd\xab゛", "\xa4\xbe" }, /*{"そ゛", "ぞ"}*/
    { "\xa4\xb5\xbf\xab゛", "\xa4\xc0" }, /*{"た゛", "だ"}*/
    { "\xa4\xb5\xc1\xab゛", "\xa4\xc2" }, /*{"ち゛", "ぢ"}*/
    { "\xa4\xb5\xc4\xab゛", "\xa4\xc5" }, /*{"つ゛", "づ"}*/
    { "\xa4\xb5\xc6\xab゛", "\xa4\xc7" }, /*{"て゛", "で"}*/
    { "\xa4\xb5\xc8\xab゛", "\xa4\xc9" }, /*{"と゛", "ど"}*/
    { "\xa4\xb5\x\xab゛", "\xa4\x" }, /*{"は゛", "ば"}*/
    { "\xa4\xb5\x\xab゛", "\xa4\x" }, /*{"ひ゛", "び"}*/
    { "\xa4\xb5\x\xab゛", "\xa4\x" }, /*{"ふ゛", "ぶ"}*/
    { "\xa4\xb5\x\xab゛", "\xa4\x" }, /*{"へ゛", "べ"}*/
    { "\xa4\xb5\x\xab゛", "\xa4\x" }, /*{"ほ゛", "ぼ"}*/
    { "\xa4\xb5\x\xab゛", "\xa4\x" },
    { "\xa4\xb5\x\xab゛", "\xa4\x" },
    { "\xa4\xb5\x\xab゛", "\xa4\x" },
    { "\xa4\xb5\x\xab゛", "\xa4\x" },
