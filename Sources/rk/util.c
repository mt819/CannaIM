...
static char* Hdrtag[] = {
  HD_TAG_MAG,  HD_TAG_SIZ,  HD_TAG_HSZ,  HD_TAG_CURV, HD_TAG_CMPV, HD_TAG_VER,
  HD_TAG_TIME, HD_TAG_REC,  HD_TAG_CAN,  HD_TAG_L2P,  HD_TAG_L2C,  HD_TAG_PAG,
  HD_TAG_LND,  HD_TAG_SND,  HD_TAG_DROF, HD_TAG_PGOF, HD_TAG_DMNM, HD_TAG_CODM,
  HD_TAG_LANG, HD_TAG_WWID, HD_TAG_WTYP, HD_TAG_COPY, HD_TAG_NOTE, HD_TAG_TYPE,
  HD_TAG_CRC,  HD_TAG_GRAM, HD_TAG_GRSZ, 0,
};
...
_RkReadHeader(int fd, struct HD* hd, off_t off_from_top)
{
  ...
  if (hd->flag[HD_MAG] != -1 || hd->data[HD_MAG].var != (long)bst4_to_l("CDIC"))
    goto read_err;
